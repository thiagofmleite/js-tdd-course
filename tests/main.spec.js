...
describe('Calc', function () {
  ...
  describe('Sub', function () {
    it('should return 2 when `sum(4,2)', function () {
  ...
  describe('Div', function () {
    it('should return 2 when `div(4,4)`', function () {
      expect(calc.div(4, 2)).to.be.equal(2);
    });

    it('should return `não é possível divisão por zero` when divide by zero', function () {
